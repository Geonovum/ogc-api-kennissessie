...
import queryables from "../../../models/common/collections/queryables.js";
...
export function get(req, res) {
  ...
  queryables.get(formatFreeUrl, format, collectionId, function (err, content) {
    if (err) {
      res
        .status(err.httpCode)
    ...
    switch (format) {
      ...
      case `html`:
        ...
        res.status(200).render(`queryables`, { content, serviceUrl });
        break;
      default:
        res.status(400).json({
