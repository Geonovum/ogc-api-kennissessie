...
const projectRing = function (points, fromProj4, toProj4, digits = null) {
...
const projectRings = function (rings, fromProj4, toProj4, digits = null) {
...
const projectMultiRings = function (
  multiRings,
  fromProj4,
  toProj4,
  digits = null
...
const _projectFeature = function (feature, fromProj4, toProj4, digits = null) {
  ...
  if (feature.geometry.type === "Point") {
    feature.geometry.coordinates = projectPoint(
    ...
    feature.geometry.coordinates = projectRing(
      feature.geometry.coordinates,
      fromProj4,
      toProj4,
      digits
    ...
    feature.geometry.coordinates = projectRings(
      feature.geometry.coordinates,
      fromProj4,
      toProj4,
      digits
    ...
    feature.geometry.coordinates = projectMultiRings(
      feature.geometry.coordinates,
      fromProj4,
      toProj4,
      digits
...
const projectFeatureCollection = function (
  _features,
  codeSridFrom,
  codeSridTo,
  digits = null
...
const projectBBox = function (
  ...
  var array = [
    pp1.geometry.coordinates[0],
    pp1.geometry.coordinates[1],
    pp2.geometry.coordinates[0],
    pp2.geometry.coordinates[1],
  ];
